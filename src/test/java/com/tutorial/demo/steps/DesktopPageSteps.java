...
import com.tutorial.demo.pages.DesktopPage;
...
public class DesktopPageSteps {
    ...
    @When("^I mouse hover  click on desktop tab$")
    public void iMouseHoverClickOnDesktopTab() {new DesktopPage().getDesktopText();
    }
}
